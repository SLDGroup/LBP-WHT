...
from .dataset_wrappers import IndexedDataset
from .tiny_imagenet import TinyImageNet
from .fgvc_aircrafts import FGVCAircraft
...
__all__.extend(["IndexedDataset", "TinyImageNet",
               "FGVCAircraft", "Food101", "Flowers102", "Pets"])
